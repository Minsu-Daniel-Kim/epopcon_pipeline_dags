...
def retrieve_and_split_dataset():
    ...
    result = mysql_wspider.get_pandas_df(sql='SELECT ID, SITE_NAME FROM wspider.MWS_COLT_ITEM')
...
dag = DAG('sell_amt_modeling_dag3',
...
#                                                     dag=dag)
#     begin_task >> apply_feature_engineering_task
#
